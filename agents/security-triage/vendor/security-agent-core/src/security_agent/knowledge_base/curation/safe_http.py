...
# Upstream: knowledge_base/curation/safe_http.py @ 380554275fdfcf177737253132bd094178314078
# See the repo-root NOTICE and knowledge_base/curation/LICENSE-redamon.
# Local changes: none (verbatim). The allowlist and the tarball caps are wider than the feeds
# carried here need — kept verbatim so re-adding one of the upstream tarball feeds is a client
# file and a pin, nothing else.
...
# Per-source caps
MAX_TARBALL_BYTES = 200 * 1024 * 1024      # tarball downloads (unused by the feeds carried here)
