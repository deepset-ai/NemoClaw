...
# Upstream: knowledge_base/atomic_io.py @ 380554275fdfcf177737253132bd094178314078
# See the repo-root NOTICE and knowledge_base/curation/LICENSE-redamon.
# Local changes: none (verbatim). NOTE: ingest_lock uses POSIX fcntl.flock — macOS/Linux only.
